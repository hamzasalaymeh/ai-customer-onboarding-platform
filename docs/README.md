...
- [`architecture-index.md`](architecture-index.md) — Comprehensive searchable index of 2070+ architectural topics across all 20 specifications.
...
- [`cloud-architecture.md`](cloud-architecture.md) — Enterprise Cloud Architecture specification overview and framework (5 parts).
- [`cloud-topic-index.md`](cloud-topic-index.md) — Detailed cloud architecture topics (210+ across 5 parts).
